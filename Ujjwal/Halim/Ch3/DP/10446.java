...
// Main Written here as UVA accepts solution class of Main only
// If testing on your own machine class name must match with the file name
// For idea please refer the same file name under .cpp this is just BigInterger Implementation
public class Main {
